...
export default function PortfoliosPage() {
    ...
    const sorted = [...portfolios].sort((a, b) => b.dealsWon - a.dealsWon);
    const totalDeals = portfolios.reduce((sum, p) => sum + p.dealsWon, 0);
    const totalFinanced = portfolios.reduce((sum, p) => sum + p.totalFinanced, 0);
    ...
    return (
        <>
            ...
            {!loading && portfolios.length === 0 ? (
                <section className="bg-white border border-[#E2DDD4] rounded-xl p-12 shadow-sm text-center">
